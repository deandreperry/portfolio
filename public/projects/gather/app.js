'use strict';
const steps = [
 {label:'HOME',title:'The next step is already waiting.',image:'assets/Home-Light.png',alt:'Gather Home with an active Friday Night plan and Continue Voting action',description:'The active plan leads the page. Its status and Continue Voting action make the next step clear.',intent:'Establish hierarchy through content and type before adding decoration.'},
